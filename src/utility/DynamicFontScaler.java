...
public class DynamicFontScaler
{
    ...
    /**
     * Applies hero-level dynamic font scaling to a node. Hero text is the
     * largest scale, intended for splash screens and major headers.
     *
     * @param node  the node whose font size will scale
     * @param root  the region whose width drives the scaling
     * @param clamp if true, font size is bounded between HERO_MIN_SIZE and HERO_MAX_SIZE
     */
    public static void applyHeroScaling(final Node node, final Region root, final boolean clamp)
    {
        if (clamp) {
    ...
    /**
     * Applies title-level dynamic font scaling to a node. Title text is
     * intended for main window titles and page headers.
     *
     * @param node  the node whose font size will scale
     * @param root  the region whose width drives the scaling
     * @param clamp if true, font size is bounded between TITLE_MIN_SIZE and TITLE_MAX_SIZE
     */
    public static void applyTitleScaling(final Node node, final Region root, final boolean clamp)
    {
        if (clamp) {
    ...
    /**
     * Applies section-level dynamic font scaling to a node. Section text is
     * intended for major section dividers within a screen.
     *
     * @param node  the node whose font size will scale
     * @param root  the region whose width drives the scaling
     * @param clamp if true, font size is bounded between SECTION_MIN_SIZE and SECTION_MAX_SIZE
     */
    public static void applySectionScaling(final Node node, final Region root, final boolean clamp)
    {
        if (clamp) {
    ...
    /**
     * Applies subheading-level dynamic font scaling to a node. Subheading text
     * is intended for subsection labels and card titles.
     *
     * @param node  the node whose font size will scale
     * @param root  the region whose width drives the scaling
     * @param clamp if true, font size is bounded between SUBHEAD_MIN_SIZE and SUBHEAD_MAX_SIZE
     */
    public static void applySubheadScaling(final Node node, final Region root, final boolean clamp)
    {
        if (clamp) {
    ...
    /**
     * Applies body-level dynamic font scaling to a node. Body text is intended
     * for paragraphs and standard descriptive content.
     *
     * @param node  the node whose font size will scale
     * @param root  the region whose width drives the scaling
     * @param clamp if true, font size is bounded between BODY_MIN_SIZE and BODY_MAX_SIZE
     */
    public static void applyBodyScaling(final Node node, final Region root, final boolean clamp)
    {
        if (clamp) {
    ...
    /**
     * Applies caption-level dynamic font scaling to a node. Caption text is
     * intended for helper text, hints, and timestamps.
     *
     * @param node  the node whose font size will scale
     * @param root  the region whose width drives the scaling
     * @param clamp if true, font size is bounded between CAPTION_MIN_SIZE and CAPTION_MAX_SIZE
     */
    public static void applyCaptionScaling(final Node node, final Region root, final boolean clamp)
    {
        if (clamp) {
    ...
    /**
     * Applies footer-level dynamic font scaling to a node. Footer text is the
     * smallest scale, intended for fine print such as version numbers and
     * copyright notices.
     *
     * @param node  the node whose font size will scale
     * @param root  the region whose width drives the scaling
     ...
     */
    public static void applyFooterScaling(final Node node, final Region root, final boolean clamp)
    {
        if (clamp) {
